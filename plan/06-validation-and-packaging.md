...
| Extension behavior | Capture/rendering/messaging/stream tests | Chrome end-to-end summary and registered-domain launcher popup passed; focused edge-case tests pending |
