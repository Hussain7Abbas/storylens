...
- [x] A novel-site logo launcher opens the same popup within the page in Playwright Chromium, stays hidden without a selector, persists dragging, and keeps the circle/popup inside resized viewports.
