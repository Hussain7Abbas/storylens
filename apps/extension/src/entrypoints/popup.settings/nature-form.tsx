...
import type { KeywordNature } from '@prisma/client';
import {
  useDeleteKeywordNaturesById,
  usePostKeywordNatures,
  usePutKeywordNaturesById,
} from '@repo/api/keyword-natures.js';
import type { PostKeywordNaturesBodyOne } from '@repo/api/schemas';
...
export function NatureForm({ mode, nature, onClose, ...props }: NatureFormProps) {
